  ...
  return (
    ...
    <div className="card bg-base-100 w-full shadow-sm">
      <div className="mt-3 ml-10 flex justify-center ">
        <h2 className="card-title text-2xl p-2 text-center">{foodName.substring(0,12)}</h2>
      </div>
      <figure className="px-10 pt-4">
        <img src={foodImageURL} alt={foodImageURL} className="rounded-xl aspect-3/2 object-cover" />
      </figure>
